...
import {
  ...
  withDirectives,
  withModifiers
} from "./chunk-4JYJ4M7P.js";
import {
  axios_default
} from "./chunk-U2L6RD7I.js";
...
var Wf = {
  ...
  mounted() {
    ...
    import("./jodit.min-NTXHMP3D.js").then((t) => {
  ...
  methods: {
    ...
    initChoices(e) {
      return new Promise((t) => {
        ...
        import("./choices-WYQK252F.js").then((i) => {
...
var bp = {
  ...
  watch: {
    modelValue() {
      !this.autosize || !this.autosizeInstance || import("./autosize.esm-4DX6Z2PT.js").then((e) => {
        nextTick(() => e.default.update(this.element));
      });
    }
  },
  mounted() {
    this.element = this.$refs.textarea.querySelector("textarea"), this.autosize && import("./autosize.esm-4DX6Z2PT.js").then((e) => {
...
var Cr = {
  ...
  init(e) {
    const t = this;
    import("./nprogress-QRE75SHE.js").then((r) => {
      let n = 0;
...
var Fp = {
  ...
  install: (e, t) => {
    ...
    t.suppress_compile_errors && (e.config.compilerOptions.onError = (n) => {
      import("./CompilerErrorMessages-6b34f14b-QQ6HQQXW.js").then((i) => {
        console.error({
